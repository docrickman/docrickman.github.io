...
layouts, bootloader versions, config formats — and an intermediate release is often the thing
...
boring page in the manual, right up until it's the entire answer — and on OT hardware, it's
the entire answer more often than anywhere else in IT.
