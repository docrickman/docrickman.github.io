...
So the crafting interface got prototyped in React first, as a full interactive mockup with
real state, where a layout idea costs thirty seconds to try. Once the design settled, the port maps
